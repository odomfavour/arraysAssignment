console.log('Vgg assignment on Arrays')
...
colors.map((colors, index) => {
  ...
  if((index + 1) == 1) {
    ending = endings[1]
    console.log(`${index + 1 + ending} choice is ${colors}`);
  }else if((index + 1) == 2) {
    ending = endings[2]
    console.log(`${index + 1 + ending} choice is ${colors}`);
  }else if((index + 1) == 3) {
...
const firstJoinArray = myColor.join(',');
const SecondJoinArray = myColor.join('+');
const thirdJoinArray = myColor.join('-');

console.log(firstJoinArray);
console.log(SecondJoinArray);
console.log(thirdJoinArray);
...
console.log('Question three (A)')

let web_developers = employees.filter(person => person.Job === 'Web Developer')
console.log(web_developers);


console.log('Question three (B)')

let web_developers_from_Nig = employees.filter(person => person.Job === 'Web Developer' && person.Country === 'Nigeria')
console.log(web_developers_from_Nig);


console.log('Question three (C)')

let peopleBelow20 = employees.filter(person => person.age < 20)
console.log("peopleBelow20");
console.log(peopleBelow20);


console.log('Question three (D)')

let activeEmployees = employees.filter(person => person.active === true);
